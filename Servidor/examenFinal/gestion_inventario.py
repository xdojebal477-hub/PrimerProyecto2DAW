...
class Inventario:
    ...
    def anadir_producto(self, producto):
        ...
        for prod in self.productos:
            if not prod.codigo==producto.codigo:
                self.productos.append(producto)
                return f"Producto con codigo {producto.codigo} añadido"
        return f"El producto con codigo {self.codigo} ya esta guardado"
    def mostrar(self):
        """
    ...
    def buscar(self, codigo):
        ...
        for prod in self.productos:
            if prod.codigo==codigo:
                #return f"El codigo {prod.codigo} existe en la base de datos"
                return prod
        return None
    ...
    def modificar(self, codigo, nombre=None, precio=None, stock=None):
        ...
        return f"El codigo {prod.codigo} no existe en la base de datos"
